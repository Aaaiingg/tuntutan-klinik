    ...
    public function index(Request $request)
{
    ...
    return view('dashboard.ptk', compact('claimsApproved','claimsToProcess', 'jumlahTuntutan','tuntutanBaharu','tuntutanDisemak','tuntutanDilulus'));
}
    public function show($id)
{
    $claim = Claim::findOrFail($id);
    return view('ptk.show', compact('claim'));
}
