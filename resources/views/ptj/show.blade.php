<x-app-layout>
    ...
    {{-- Senarai Tuntutan--}}
            <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Senarai Tuntutan Jabatan: {{ auth()->check() ? auth()->user()->deptId : 'Tidak Diketahui' }}</h3>
                </div>
    ...
    {{ \Carbon\Carbon::parse($claim->tarikh_resit)->translatedFormat('F Y') }}
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="p-4 text-center text-gray-500 dark:text-gray-400">Tiada tuntutan dijumpai.</td>
                                </tr>
                            @endforelse
